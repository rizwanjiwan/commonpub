<?php
/**
 * Ripped off from https://github.com/waza-ari/monolog-mysql but needed to rewrite chunks because it was bug ridden
 */
...
class MySqlHandler extends AbstractProcessingHandler
{
	...
	public function __construct(
		...
		//else
		 //   LogManager::debug('[MySqlHandler] No PDO provided');
		$this->table = $table;
	...
	protected function write(array $record): void
	{
        ...
        LogManager::debug('[MySqlHandler] writing to db');

		$result=$this->statement->execute($contentArray);
		/*if($result===false)
        {
            LogManager::debug('[MySqlHandler] failed: '.json_encode($this->statement->errorInfo()));
            LogManager::debug($this->statement->queryString);
        }
		*/
	}
}
